		...
		if (condot(words[5]) and condot(words[4])):
			...
			for row in Districts:
				...
				if bestdist > dist :
					loc=row[0];
					bestdist=dist
			if((int(words[6])<32) and (int(words[6])>0) and (int(words[7])<13) and (int(words[7])>0) and (int(words[8])>1000) and 				(int(words[9])<23)):
				if (int(words[9])>4 and int(words[9])<=12):
					print(loc+words[6]+words[7]+words[8]+"morning"+"\t"+words[2])
				elif(int(words[9])>12 and int(words[9])<=16):
					print(loc+words[6]+words[7]+words[8]+"midday"+"\t"+words[2])
				elif(int(words[9])>16 and int(words[9])<=21):
					print(loc+words[6]+words[7]+words[8]+"afternoon"+"\t"+words[2])
				elif(int(words[9])>21 or int(words[9])<=4):
					print(loc+words[6]+words[7]+words[8]+"night"+"\t"+words[2])
		bestdist=1000
